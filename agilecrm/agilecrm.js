...
var defaultHandler = function (success, failure) {
...
ContactAPI.prototype.getListContacts = function getListContacts(success, failure) {
    ...
    https.get(options, defaultHandler(success, failure))
      .on("error", function(e){
        if (failure) {
            failure(e);
        }
...
ContactAPI.prototype.add = function add(contact, success, failure) {
    ...
    var post = https.request(options,defaultHandler(success, failure))
      ;
...
ContactAPI.prototype.update = function update(contact, success, failure) {
    ...
    var put = https.request(options,defaultHandler(success, failure))
      ;
...
ContactAPI.prototype.deleteContact = function deleteContact(contactId, success, failure) {
    ...
    var del = https.request(options,defaultHandler(success, failure))
      ;
